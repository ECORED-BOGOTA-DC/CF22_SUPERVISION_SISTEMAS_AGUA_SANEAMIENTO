  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Tratamiento de lodos
        p.mb-4 Reconocer las etapas necesarias para llevar a cabo el tratamiento de lodos, teniendo en cuenta la potabilización del agua de manera eficiente y segura.
